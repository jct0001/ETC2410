...
$$\text {Confidence interval}: (`r coef(summary(fit1))[1, "Estimate"]` - `r coef(summary(fit1))[1, "Std. Error"]` * `r qt(1 - alpha_1 / 2, 472)`, `r coef(summary(fit1))[1, "Estimate"]` + `r coef(summary(fit1))[1, "Std. Error"]` * `r qt(1 - alpha_1 / 2, 472)`)$$
